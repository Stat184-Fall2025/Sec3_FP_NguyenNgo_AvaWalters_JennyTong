...
This report analyzes and examines the 2024 World Happiness Report data to understand how key factors, specifically life evaluation, economic prosperity (GDP) and governance (corruption perception), influence a country's happiness rankings. The key factors we are interested in studying are:
...
# Summary Statistics {#sec-visualization}
...
{#sec-limits} \## Limitations and Future Research

{#sec-contributions} \# Author Contributions
