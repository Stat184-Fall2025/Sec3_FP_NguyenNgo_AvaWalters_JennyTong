...
# STEP 5: Compute correlation of factors with the rank
factor_correlations <- happiness_2024 %>% 
  select(rank, life_evaluation, gdp, corruption, social_support, health_life_expectancy, freedom, generosity) %>% 
  # compute a correlation matrix
  cor(use = "complete.obs") %>% 
  as.data.frame() M
# convert to a column
rownames_to_column("factor") %>%
  # extract correlation with rank
...
# STEP 7: Create bottom 10 least happy countries table
