...
\newpage
Data comes from the World Happiness Report [@helliwell2025] and the dataset is provided by SDSN [@worldhappiness2024].
Polling data come from Gallup [@gallup2024].

# References {#sec-references}


```{r codeAppend, ref.label=knitr::all_labels(), echo=TRUE, eval=FALSE, include=FALSE}
```